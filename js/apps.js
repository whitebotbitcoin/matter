...
const sttaddr = "0x2418dc4d42c814d5fc995e00a1beb5c2b554f4af";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x2418dc4d42c814d5fc995e00a1beb5c2b554f4af";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://bitcoinwhite.net?ref=' + document.getElementById('refaddress').value;
        }
    }
}
